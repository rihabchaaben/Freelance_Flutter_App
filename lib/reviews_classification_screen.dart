...
class ReviewsAnalysis extends StatefulWidget {
  @override
  _ReviewsAnalysisState createState() => _ReviewsAnalysisState();
}

class _ReviewsAnalysisState extends State<ReviewsAnalysis> {
